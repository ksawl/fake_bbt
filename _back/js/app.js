	...
	function functions_getHash() {
        ...
        function initBooks() {
            if (document.querySelector("[data-book]")) {
                ...
                let version = window.location.hash.substring(1) || localStorage.getItem("defaultLanguage");
                for (let value in pageInfo) {
                    titles.innerHTML += `<button type="button" class="book__navigation-title"><span>${value}</span></button>`;
                    body.innerHTML += `<div data-open-parent class="book__wrapper-body" id="${value.slice(1)}"></div>`;
                }
                if (imagesInfo[id][0]["show-page"] == 'true') document.querySelector(".book__navigation-title").classList.add("_tab-active");
                let tabsPanels = document.querySelectorAll(".book__wrapper-body");
                let p = 1;
                let i = 0, k = 0;
                while (i < tabsPanels.length) for (let value in pageInfo) {
                    let f = 1;
                    for (let key in pageInfo[value]) {
                        tabsPanels[i].insertAdjacentHTML("beforeend", `     \n
                                <section class="book__block book-info ${k % 2 !== 0 ? "book-info--white" : ""}">\n
                                    <div class="book-info__container">\n
                                        <div class="book-info__image" data-book-gallery>\n
                                            <div class="book-info__main"><img src="./img/book/${pageInfo[value][key]["images"][0]}" width="367" height="534" alt="" class="book-info__img"></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][1] ? pageInfo[value][key]["images"][1] : ""}" alt=""></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][2] ? pageInfo[value][key]["images"][2] : ""}" alt=""></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][3] ? pageInfo[value][key]["images"][3] : ""}" alt=""></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][4] ? pageInfo[value][key]["images"][4] : ""}" alt=""></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][5] ? pageInfo[value][key]["images"][5] : ""}" alt=""></div>\n
                                            <div class="book-info__mini"><img src="./img/book/${pageInfo[value][key]["images"][6] ? pageInfo[value][key]["images"][6] : ""}" alt=""></div>\n
                                            ${(pageInfo[value][key]["cover-needed"] == 'true') ? '<div class="book-info__tooltip"><span class="book-info__tooltip-title" data-language="coverNeeded-title">Cover required!</span><span class="book-info__tooltip-content" data-language="coverNeeded-content">If you have a better cover for this book, please contact us via the feedback form at <a href="annoncment.html">http://bhaktivedanta-book-trust.com/annoncment.html</a></span></div>' : ""}\n
                                        </div>\n
                                        <div class="book-info__content">\n
                                            <div class="book-info__header">\n
                                                <h2 class="book-info__titleimg">\n
                                                    <img data-language="${key}-bookNameImage" src="./img/titles/${pageInfo[value][key]["block-name-image"] ? pageInfo[value][key]["block-name-image"] : "Значение отсутствует"}" alt="">\n
                                                </h2>\n
                                                <h3 class="book-info__title" data-language="${key}-bookTitle">${pageInfo[value][key]["block-title"] ? pageInfo[value][key]["block-title"] : "Значение отсутствует"}</h3>\n
                                                <span class="book-info__subtitle" data-language="${key}-bookSubTitle">${pageInfo[value][key]["block-subtitle"] ? pageInfo[value][key]["block-subtitle"] : "Значение отсутствует"}</span>\n
                                                <span class="book-info__descr" data-language="${key}-bookDescr">${pageInfo[value][key]["block-addition-description"] ? pageInfo[value][key]["block-addition-description"] : "Значение отсутствует"}</span>\n
                                            </div>\n
                                            <table class="book-info__table">\n
                                                <tbody>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-1">Edition</td>\n
                                                        <td data-language="${key}-lineEdition">${pageInfo[value][key]["info-table"][0] ? pageInfo[value][key]["info-table"][0] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-2">Pub.Date</td>\n
                                                        <td data-language="${key}-linePubDate">${pageInfo[value][key]["info-table"][1] ? pageInfo[value][key]["info-table"][1] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-3">Language</td>\n
                                                        <td data-language="${key}-lineLanguage">${pageInfo[value][key]["info-table"][2] ? pageInfo[value][key]["info-table"][2] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
							<td data-language="${key}-infoTableNprinting">${pageInfo[value][key]["info_table_print"] ? pageInfo[value][key]["info_table_print"] : "Значение отсутствует"}</td>\n
                                                        <td data-language="${key}-linePrinting">${pageInfo[value][key]["info-table"][3] ? pageInfo[value][key]["info-table"][3] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-5">Printed by</td>\n
                                                        <td data-language="${key}-linePrintedBy">${pageInfo[value][key]["info-table"][4] ? pageInfo[value][key]["info-table"][4] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-6">Pages</td>\n
                                                        <td data-language="${key}-linePages">${pageInfo[value][key]["info-table"][5] ? pageInfo[value][key]["info-table"][5] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-7">size</td>\n
                                                        <td data-language="${key}-lineSize">${pageInfo[value][key]["info-table"][6] ? pageInfo[value][key]["info-table"][6] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-8">lccn</td>\n
                                                        <td data-language="${key}-lineLccn">${pageInfo[value][key]["info-table"][7] ? pageInfo[value][key]["info-table"][7] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-9">Reg. num.</td>\n
                                                        <td data-language="${key}-lineRegNum">${pageInfo[value][key]["info-table"][8] ? pageInfo[value][key]["info-table"][8] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                    <tr>\n
                                                        <td data-language="bookLine-10">Translated into</td>\n
                                                        <td data-language="${key}-lineTranslatedInto">${pageInfo[value][key]["info-table"][9] ? pageInfo[value][key]["info-table"][9] : "Значение отсутствует"}</td>\n
                                                    </tr>\n
                                                </tbody>\n
                                            </table>\n
                                        </div>\n
                                    ...
                                    <button data-open-button class="book-info__more">\n
                                        <span data-language="bookDetails">${"ru" == version ? "подробнее" : "see details"}</span>\n
                                    </button>\n
                                </section>\n
                                <section class="book-details ${k % 2 !== 0 ? "book-details--white" : ""}" data-open-body>\n
                                    <div class="book-details__container">\n
                                        ...
                                        <div class="book-details__text">\n
                                            ...
                                            <div data-language="${key}-editionText">${pageInfo[value][key]["block-text"] ? pageInfo[value][key]["block-text"] : "Значение отсутствует"}</div>\n
                                            <!--BUG div data-language="${id}-detailsText-${p}">${pageInfo[value][key]["block-text"] ? pageInfo[value][key]["block-text"] : "Значение отсутствует"}</div-->\n
                                        </div>\n
        ...
        function initImages(id) {
            ...
            let p = 0;
            for (let i = 0; i < certainPage.length; i++) if ("" == certainPage[i]["previewImage"]) imageTitles.innerHTML += `<div><img src="./img/assets/${certainPage[i]["previewImage"] ? certainPage[i]["previewImage"] : ""}" alt="" style="opacity:0;visibility:hidden;" aria--hidden="true"></div>`; else {
                imageTitles.innerHTML += `\n         <div class="book__image">\n            <img class="book__image-tooltip" data-popcorn src="./img/assets/${certainPage[i]["previewImage"] ? certainPage[i]["previewImage"] : ""}" alt="">\n            <div data-tooltip class="books__tooltip" style="--count: ${certainPage[i]["column-count"] ? certainPage[i]["column-count"] : ""}">                \n            </div>\n         </div>`;
                initTooltipImages(document.querySelectorAll("[data-tooltip]")[p], certainPage[i]);
                p++;
            }
            initImageConnection();
            initTooltips();
        ...
        function scrollToBlock() {
            if (localStorage.getItem("scrollTo")) {
                ...
                const tabsTitles = document.querySelector("[data-tabs-titles]")?.children;
                ...
                if (tabsBodies[object.tab]) {
                    const sections = tabsBodies[object.tab].querySelectorAll(".book-info");
                    setTimeout((() => {
                        window.scrollTo({
        ...
        function initImageConnection() {
            ...
            if (tabsImages.length && tabsImages.length === tabsTitles.length) for (let i = 0; i < tabsImages.length; i++) tabsImages[i].addEventListener("click", (() => {
                tabsTitles[i].click();
            }));
            if (imagesTooltips.length === tabsBlocks.length) imagesTooltips.forEach(((el, i) => {
                const sections = tabsBlocks[i].querySelectorAll(".book-info");
                const buttons = el.querySelectorAll(".books__tooltip-image");
                if (buttons.length && sections.length) buttons.forEach(((el, j) => {
        ...
        function initTables(id) {
            ...
            let p = 1;
            let i = 0;
            while (i < sliders.length) for (let value in certainPage) {
                let f = 1;
                if (certainPage[`table-${i + 1}`]) for (let key in certainPage[value]) {
                    sliders[i].insertAdjacentHTML("beforeend", `\n
			<div class="book-details__slide swiper-slide swiper-slide-active" data-book-language="${certainPage[value][key]["translation-language"] ? certainPage[value][key]["translation-language"] : "english"}" data-popup-number=${id}-popup-${p} data-popup="#book">\n
			    <div class="book-details__line">\n
				<div>\n
				    <h3 data-language="${key}-tableNprinting">${certainPage[value][key]["printings_name"] ? certainPage[value][key]["printings_name"] : "Значение отсутствует"}</h3>\n
				    <p data-language="${key}-tableTypography">${certainPage[value][key]["typography"] ? certainPage[value][key]["typography"] : "Значение отсутствует"}</p>\n
				</div>\n
				<div>\n
				    <span style="font-size: 24px" data-language="${key}-tableYearPrint">${certainPage[value][key]["year_of_printing"] ? certainPage[value][key]["year_of_printing"] : "Значение отсутствует"}</span>\n
				    <!--span data-language="${key}-tableYearPrint">${certainPage[value][key]["year_of_printing"] ? certainPage[value][key]["year_of_printing"] : "Значение отсутствует"}</span-->\n
				</div>\n
				<div>\n
				    <h3 data-language="${key}-tableCopies">${certainPage[value][key]["number_of_copies"] ? certainPage[value][key]["number_of_copies"] : "Значение отсутствует"}</h3>\n
				    <p data-language="${key}-tableBookProperties">${certainPage[value][key]["book_properties"] ? certainPage[value][key]["book_properties"] : "Значение отсутствует"}</p>\n
				</div>\n
			    </div>\n
			</div>\n`);
                    initPopup(document.querySelector(`.book-details__slide[data-popup-number=${id}-popup-${p}]`), certainPage[value][key]);
                    p++;
                    f++;
                }
                i++;
            ...
            if (openParents.length) {
                openParents.forEach((parent => {
                    ...
                    buttons.forEach(((button, i) => {
                        ...
                        const slidesLength = body.querySelectorAll(".book-details__slide").length;
                        button.addEventListener("click", (() => {
                            toggleTwoClasses(body, description, button, nextButton, slidesLength, "is-visible", "is-hidden", 500);
                        }));
                        closeButtons.forEach((closeButton => {
                            closeButton.addEventListener("click", (() => {
                                closeBody(body, description, button, "is-visible", "is-hidden", 500);
                            }));
                        }));
                    }));
                }));
                function toggleTwoClasses(element, description, button, nextButton, slidesLength, first, second, timeOfAnimation) {
                    if (!element.classList.contains(first)) {
                        element.classList.add(first);
                        element.classList.remove(second);
                        description.textContent = "ru" == window.location.hash.substring(1) || "ru" == localStorage.getItem("defaultLanguage") ? "закрыть" : "collapse see details";
                        button.classList.add("book-info__more--open");
                        element.style.maxHeight = element.querySelector(".book-details__container").scrollHeight + "px";
                        window.addEventListener("resize", (() => {
                            element.style.maxHeight = element.querySelector(".book-details__container").scrollHeight + "px";
                        }));
                    } else {
                        description.textContent = "ru" == window.location.hash.substring(1) || "ru" == localStorage.getItem("defaultLanguage") ? "подробнее" : "see details";
                ...
                function closeBody(element, description, button, first, second, timeOfAnimation) {
                    description.textContent = "ru" == window.location.hash.substring(1) || "ru" == localStorage.getItem("defaultLanguage") ? "подробнее" : "see details";
                    button.classList.remove("book-info__more--open");
                    element.classList.add(second);
                    element.style.maxHeight = null;
        ...
        function languageFilter(object) {
            const languageLists = document.querySelectorAll(".book-details__language-list");
            let languageChange = {
                french: [ "French", "FRA" ],
                deutsch: [ "Deutsch", "DEU" ],
                english: [ "English", "ENG" ],
            ...
            if (languageLists.length) languageLists.forEach((list => {
                const languageButtons = list.querySelectorAll("[data-slider-language]");
                const sliderLines = list.closest(".book-details__table-block").querySelectorAll("[data-book-language]");
                const sliderWrapper = list.closest(".book-details__table-block").querySelector(".book-details__wrapper");
                const prevButton = list.closest(".book-details__table-block").querySelector(".book-details__button--prev");
                const nextButton = list.closest(".book-details__table-block").querySelector(".book-details__button--next");
                localStorage.setItem("translate", "english");
                let count = {};
                let arr = [];
                for (let i = 0; i < sliderLines.length; i++) {
                    arr.push(sliderLines[i].dataset.bookLanguage);
                    if (!count[`${sliderLines[i].dataset.bookLanguage}`]) count[`${sliderLines[i].dataset.bookLanguage.toLowerCase()}`] = 1; else count[`${sliderLines[i].dataset.bookLanguage.toLowerCase()}`] += 1;
                }
                ...
                languageButtons.forEach((button => {
                    if (!arr.includes(button.dataset.sliderLanguage.toLowerCase())) button.parentElement.style.display = "none";
                    ...
                    if (count["english"] - 4 > 0) {
                        nextButton.querySelector("span").textContent = count["english"] - 4;
                    ...
                    sliderLines.forEach((el => {
                        if ("english" !== el.dataset.bookLanguage.toLowerCase()) el.style.display = "none";
                    }));
                    button.addEventListener("click", (() => {
                        localStorage.setItem("translate", button.dataset.sliderLanguage);
                        ...
                        languageButtons.forEach((el => {
                            ...
                            el.textContent = languageChange[el.dataset.sliderLanguage.toLowerCase()][1];
                        }));
                        button.parentElement.classList.add("chosen");
                        button.textContent = languageChange[button.dataset.sliderLanguage.toLowerCase()][0];
                        if (count[button.dataset.sliderLanguage.toLowerCase()] - 4 > 0) {
                            nextButton.querySelector("span").textContent = count[button.dataset.sliderLanguage.toLowerCase()] - 4;
                            nextButton.disabled = false;
                            nextButton.classList.remove("swiper-button-disabled");
                        } else {
                            nextButton.querySelector("span").textContent = "0";
                        ...
                        sliderLines.forEach((el => {
                            ...
                            if (el.dataset.bookLanguage.toLowerCase() !== button.dataset.sliderLanguage.toLowerCase()) el.style.display = "none";
                        }));
                    }));
                }));
            }));
        ...
        function initPopup(elem, object) {
            ...
            const popupTableLast = popup.querySelectorAll(".book-info__table tr td:last-child");
            elem.addEventListener("click", (() => {
                let version = window.location.hash.substring(1) || localStorage.getItem("defaultLanguage");
                popupTitle.innerHTML = object[`block-title-${version}`] ? object[`block-title-${version}`] : object["block-title"] ? object["block-title"] : "Значение отсутствует";
                popupImageTitle.src = `./img/titles/${object[`block-name-image-${version}`] ? object[`block-name-image-${version}`] : object["block-name-image"] ? object["block-name-image"] : "./img/titles/01.svg"}`;
                popupSubTitle.innerHTML = object[`block-subtitle-${version}`] ? object[`block-subtitle-${version}`] : object["block-subtitle"] ? object["block-subtitle"] : "Значение отсутствует";
                popupDescr.innerHTML = object[`block-addition-description-${version}`] ? object[`block-addition-description-${version}`] : object["block-addition-description"] ? object["block-addition-description"] : "Значение отсутствует";
                popupText.innerHTML = object[`block-text-${version}`] ? object[`block-text-${version}`] : object["block-text"] ? object["block-text"] : "Значение отсутствует";
                popupPrinting.innerHTML = object[`info_table_print-${version}`] ? object[`info_table_print-${version}`] : object["info_table_print"] ? object["info_table_print"] : "Значение отсутствует";
...
//                    image.insertAdjacentHTML("beforeend", `<div class="book-info__tooltip"><span class="book-info__tooltip-title" data-language="coverNeeded-title">Cover Required!</span><span class="book-info__tooltip-content" data-language="coverNeeded-content">If you have a better cover for this book, please contact us via the feedback form at <a href="annoncment.html">http://bhaktivedanta-book-trust.com/annoncment.html</a></span></div>`);
                    image.insertAdjacentHTML("beforeend", `<div class="book-info__tooltip"><span class="book-info__tooltip-title" data-language="coverNeeded-title">${languages["coverNeeded-title"]["ru" == window.location.hash.substring(1) || "ru" == localStorage.getItem("defaultLanguage") ? "ru" : "en"]}</span><span class="book-info__tooltip-content" data-language="coverNeeded-content">${languages["coverNeeded-content"]["ru" == window.location.hash.substring(1) || "ru" == localStorage.getItem("defaultLanguage") ? "ru" : "en"]}</span></div>`);
                }
//                for (let i = 0; i < popupTableLast.length; i++) popupTableLast[i].textContent = object[`info-table-${version}`] ? object[`info-table-${version}`][i] : object["info-table"][i] ? object["info-table"][i] : "Значение отсутствует";
                for (let i = 0; i < popupTableLast.length; i++) popupTableLast[i].innerHTML = object[`info-table-${version}`] ? object[`info-table-${version}`][i] : object["info-table"][i] ? object["info-table"][i] : "Значение отсутствует";
                for (let i = 0; i < popupImages.length; i++) popupImages[i].src = `./img/book/${object["images"][i] ? object["images"][i] : ""}`;
            }));
        }
        function tooltips() {
...
//                        this.popupLogging(this.targetOpen.selector);
        ...
        function initSliders() {
            if (document.querySelector(".trustees__slider-block")) new core(".trustees__slider", {
            ...
            if (document.querySelector(".beneficiary")) new core(".beneficiary__slider", {
                modules: [ Navigation, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".documents")) new core(".documents__slider_1", {
                modules: [ Navigation, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".documents")) new core(".documents__slider_2", {
                modules: [ Navigation, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".documents")) new core(".documents__slider_3", {
            ...
            if (document.querySelector(".book")) new core(".book-details__slider", {
                ...
                on: {
                    init: function(e) {
                        this.navigation.$prevEl[0].children[0].textContent = e.activeIndex;
                    },
...
***************************************************************************** */
        ...
        var LightGallery = function() {
            ...
            LightGallery.prototype.addSlideVideoInfo = function(items) {
                ...
                items.forEach((function(element, index) {
                    ...
                    if (element.__slideVideoInfo && _this.settings.loadYouTubePoster && !element.poster && element.__slideVideoInfo.youtube) element.poster = "//web.archive.org/web/20221215121232/http://img.youtube.com/vi/" + element.__slideVideoInfo.youtube[1] + "/maxresdefault.jpg";
                }));
            };
        ...
        document.addEventListener("DOMContentLoaded", (() => {
        	...
        	if (localStorage.getItem("defaultLanguage")) {
        	    location.href = `${window.location.pathname}#${localStorage.getItem("defaultLanguage")}`; 
        	}else{ 
            ...
            function changeLanguage() {
                ...
                document.querySelector("title").innerHTML = languages["pageTitle"][language];
                if (document.querySelectorAll("[data-language]").length > 0) document.querySelectorAll("[data-language]").forEach((elem => {
                    ...
                    if (languages[elem.dataset.language]) if (languages[elem.dataset.language][language]) if ("IMG" == elem.tagName) {
            ...
            if (document.querySelector(".assets")) {
                ...
                links.forEach((link => {
                    link.addEventListener("click", (() => {
                        if (!list.classList.contains("assets__books--active")) return; else {
                ...
                booksItems.forEach(((item, i) => {
                    ...
                    if (innerItems.length) innerItems.forEach(((item, p) => {
                        let tooltips = item.querySelectorAll(".books__tooltip-image");
                        if (tooltips.length) tooltips.forEach(((tooltip, j) => {
            ...
            if (document.querySelector(".header__lower-line")) {
                ...
                window.addEventListener("scroll", (() => {
                    ...
                    if (scrollDistance < lastY) headerLine.classList.add("shown"); else headerLine.classList.remove("shown");
...
//	    const IS_IPHONE = (navigator.userAgent.match(/iPhone/i) != null) || (navigator.userAgent.match(/iPod/i) != null);
		...
		switch(lang_set){
		    case 'ru':
			element.href = "https://www.youtube.com/playlist?list=PL3dNiCipcYFMKLzowYfS5ryl1LtDjue11"; // Default Playlist
			break;
		    
		    default:
			element.href = "https://www.youtube.com/playlist?list=PL3dNiCipcYFN8Xi8JcyxXp6B-WSHxx1B4"; // Eglish Playlist
			break;
		}
	    }else{
		element.href = "https://www.youtube.com/playlist?list=PL3dNiCipcYFN8Xi8JcyxXp6B-WSHxx1B4"; // Eglish Playlist
